...
while Count <= 100:
    ...
    if Choice == "1":
        print("\n>>>>>>>>>>> ADD an ELEMENT <<<<<<<<<<<")
        try:
            Element = int(input("Please input an Element to be added: "))
        except ValueError:
            print("\nInvalid input")
        else:
    ...
    # (2) This is the Insert Element Section ----
        ...
        print("\n>>>>>>>>>>> INSERT an ELEMENT <<<<<<<<<<<")
        try:
            Index = int(input("Please input an index number you want to insert the new element: "))
    ...
    # (3) This is the Modify Element Section -----
        ...
        print("\n>>>>>>>>>>> MODIFY an ELEMENT <<<<<<<<<<<")
        try:
            Indexnum = int(input("Please input the index you want to modify: "))
    ...
    # (4) This is the Delete Element Section:
        ...
        try:
            Index = int(input("Please input the index number you want to delete: "))
        except ValueError:
            print("\nInvalid input")
        else:
